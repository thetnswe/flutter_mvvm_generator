...
export class WidgetFile {
    ...
    public createMobile() {
        this.createFiles(this.snakeCasedFileName + '_mobile.dart', new Mobile(this.capitalisedFileName, this.snakeCasedFileName, 'Mobile').dartString);
    }

    public createDesktop() {

        this.createFiles(this.snakeCasedFileName + '_desktop.dart', new Desktop(this.capitalisedFileName, this.snakeCasedFileName, 'Desktop').dartString);
    }

    public createTablet() {
        this.createFiles(this.snakeCasedFileName + '_tablet.dart', new Tablet(this.capitalisedFileName, this.snakeCasedFileName, 'Tablet').dartString);
    }
    ...
    private get capitalisedFileName(): string {
        return this.fileName[0].toUpperCase() + this.fileName.slice(1);
    }
